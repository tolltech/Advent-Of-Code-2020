    ...
    public class Task04
    {
        ...
        public int Task(string input)
        {
            ...
            for (var i = 0; i < lines.Length; ++i)
            {
                ...
                {
                    if (required.All(x => fields.Contains(x)))
                    {
                        ++acc;
                    }
                    fields.Clear();
                ...
                {
                    fields.Add(split.Split(new[] {":"}, StringSplitOptions.RemoveEmptyEntries)[0]);
                }
            }
        ...
        {
            yield return new TestCaseData(@"ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
