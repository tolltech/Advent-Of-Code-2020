...
namespace AoC_2020
{
    ...
    public class Task11
    {
        ...
        private int CountAround(char[][] map, int x, int y, char c)
        {
            var acc = 0;
            ...
            for (var deltaY = -1; deltaY <= 1; ++deltaY)
            {
                ...
                if (newY >= map.Length || newY < 0) continue;
                if (newX >= map[y].Length || newX < 0) continue;
...
LLLLL.LLLLLL.LLLLL.LLLLLLLLL.LLLLLLLLL.LLLLLLL.LLLLLLL.LLLLLL.LLLLL.LLLLLLLL.LLLLL.LLLLLL.LLLLLLL").Returns(2427);
        }
    }
}